...
Các yêu cầu của DocVault được chia theo hai hướng để bám sát phạm vi đề tài. Hướng thứ nhất là quản lý tài liệu bảo mật, tập trung vào vòng đời tài liệu, version file, workflow, phân quyền, audit log, evidence và retention. Hướng thứ hai là kiểm soát quá trình phát hành, tập trung vào pipeline, security gate, container artifact, GitOps, Kubernetes và bằng chứng vận hành.

Cách chia này giúp việc phân tích yêu cầu rõ ràng hơn. Những yêu cầu như tạo tài liệu, upload version, submit, approve, preview/download hay evidence thuộc về luồng nghiệp vụ. Trong khi đó, SAST, SCA, image scan, IaC scan, GitOps, Argo CD health check, smoke test và ZAP là các yêu cầu kiểm chứng release.
