...
Để định hướng thiết kế bảo mật, hệ thống xem xét các nhóm rủi ro sau. Mỗi nhóm được phân loại theo khung STRIDE \cite{microsoft_stride} để làm rõ bản chất mối đe dọa và liên kết với biện pháp giảm thiểu tương ứng trong DocVault.
