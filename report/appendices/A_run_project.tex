...
Frontend chạy trên port \code{3006} theo script \code{dev} của \code{apps/web}:
...
\begin{itemize}
  \item \code{viewer1} (vai trò \code{viewer})
  \item \code{editor1} (vai trò \code{editor})
  \item \code{approver1} (vai trò \code{approver})
  \item \code{co1} (vai trò \code{compliance\_officer})
  \item \code{admin1} (vai trò \code{admin})
\end{itemize}
