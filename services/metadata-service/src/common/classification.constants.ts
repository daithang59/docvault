...
export const CLASSIFICATION_RETENTION_DAYS: Record<ClassificationLevel, number> = {
  PUBLIC:       730,  // 2 năm
  INTERNAL:     365,  // 1 năm
...
export const CLASSIFICATION_WATERMARK_LEVELS: Record<ClassificationLevel, boolean> = {
  PUBLIC:       false,
  INTERNAL:     false,
  CONFIDENTIAL: true,
  SECRET:        true,
