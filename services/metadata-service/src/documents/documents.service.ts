...
export class DocumentsService {
   ...
   * Delegates to ApproverDirectoryService (extracted so VersionsService can
   * resolve the same recipients without a circular module dependency).
   */
  async getApprovers(): Promise<{ userIds: string[] }> {
    return this.approverDirectory.getApprovers();
  }
}
